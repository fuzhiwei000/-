<template>
  <div class="infoList">
    ...
    <el-dialog :title="state ? '添加学生信息' : '编辑学生信息'" :visible.sync="dialogFormVisible" width="500px">
...
export default {
  ...
  methods: {
    ...
    closeInfo(form) {
      ...
      this.$refs[form].resetFields()//清空验证
